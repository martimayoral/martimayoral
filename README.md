...
<div align="center">
  ...
  **Software Engineer specializing in React, TypeScript & Web3**
  
  [![Website](https://img.shields.io/badge/Portfolio-martimayo.com-blue?style=flat-square&logo=google-chrome)](https://martimayo.com)
  [![LinkedIn](https://img.shields.io/badge/LinkedIn-Martí_Mayoral-0077B5?style=flat-square&logo=linkedin)](https://linkedin.com/in/martimayoral/)
  [![Email](https://img.shields.io/badge/Email-marti@martimayo.com-D14836?style=flat-square&logo=gmail)](mailto:marti@martimayo.com)
  
</div>

## 🚀 About Me

I'm a passionate software engineer with over 5 years of experience building scalable web applications, SDKs, and interactive experiences. I graduated with honors in Computer Engineering from Pompeu Fabra University (ranked 8th out of 70).

Currently working at **Openfort** as a TypeScript Engineer, where I'm building Web3 infrastructure that helps businesses integrate wallet solutions seamlessly. I love crafting beautiful UIs, optimizing performance, and creating developer-friendly tools.

### 💼 Current Focus

- 🔨 Building the **[@openfort/react](https://github.com/openfort-xyz/openfort-js)** SDK for embedded Web3 wallets
- 🎨 Creating smooth animations with **Framer Motion**
- 🏗️ Architecting scalable React applications with strong TypeScript typing
- 🌐 Working with modern Web3 libraries like **Viem** and **Wagmi**
...
const marti = {
  ...
  technologies: {
    frontEnd: ["React", "Redux", "Framer Motion", "Tailwind"],
    web3: ["Viem", "Wagmi", "Web3 Wallets"],
    graphics: ["Unity", "Three.js", "PixiJS", "OpenGL"],
    tools: ["Git", "PostHog", "Sentry", "Storybook"]
  },
  architecture: ["SDKs", "Component Libraries", "RESTful APIs"],
  currentlyLearning: "Advanced Web3 Infrastructure",
  funFact: "Former trampoline gymnastics coach! 🤸"
};
```
...
- 💼 Portfolio: [martimayo.com](https://martimayo.com)
- 💌 Email: [marti@martimayo.com](mailto:marti@martimayo.com)
- 🔗 LinkedIn: [/in/martimayoral](https://linkedin.com/in/martimayoral/)
